...
<html lang="en">
<head>
	<title>The Hallowed Hog- Picture Resources</title>
...
<div class="textContainer">
		<h1 style="font-size:40px; color:#059bd8;margin-bottom:-10px;">Picture Resources</h1>
		<p>All Pictures here are free to use and have waived copyright. Feel free to use them for your articles!
		</p>
		<div class="imgContainer" style="margin-left:10%;">
			<a href="resources/Pictures/hog.jpg"><img src="resources/Pictures/hog.jpg" ></a>
			<!--
		...
		<div class="imgContainer" style="margin-left:21%;">
			<!--
			<a href="resources/Templates/EmphasisSplit.docx"><img src="resources/Templates/EmphasisSplit.PNG" ></a>
			<a href="resources/Templates/MultiPic.docx"><img src="resources/Templates/MultiPic.PNG" ></a></br></br>
			-->
		</div>
