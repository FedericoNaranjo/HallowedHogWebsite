  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
		...
		<!--
		<li><a href="">Advice Columns</a>
          <ul>
		  	<li><a href="Advice.php">Advice Home</a></li>
            <li><a href="HitlersMustacheHome.php">Ask Hitlers Mustache</a></li>
          </ul>
        </li>
		-->
...
<!-- NEWS SECTION, only for important updates-->
<!--
<div style="width:100%;margin-top:5px;">
	<div style="width:50%;margin-left:25%;border: solid #9999FF;border-width:2px;">
		<p style="background:#9999FF;color:white;text-align: center !important;font-size:20px;margin-top:-1px;">LATEST NEWS</p>
		<p style="text-align: center !important;font-size:15px;">Issue 6 is now out, get it while its hot!(JK its Canada.) On an unrelated note, if you have any information on the mysterious vandal who wrote about The Hog in chalk all over campus, please help campus security bring this man to justice!</p>
	</div>
</div>
-->
<!-- Main Display -->
  ...
  <div class="container">
    <div class="content">
      <div id="featured_slide">
        <ul id="featurednews">
          <li>
              <img src="<?php echo $All1Pic; ?>" alt="" style="width:100%; height:100%;"/>
    ...
    <div class="column">
      <ul class="latestnews">
        <li>
            ...
            <a href="<?php echo "viewPageTest.php?article=".$All6Article; ?>">
                <img src="<?php echo $All6Pic; ?>" alt="" style="height:100px;width:100px;" />
            </a>
            <p><strong><a href="<?php echo "viewPageTest.php?article=".$All6Article; ?>"><?php echo $All6Title; ?></a></strong></br><?php echo $All6Caption;?>
            </p>
        </li>
      
        <li>
            <!-- made image clickable link on May 12, 2016 -->
            <a href="<?php echo "viewPageTest.php?article=".$All7Article; ?>">
                <img src="<?php echo $All7Pic; ?>" alt="" style="height:100px;width:100px;" />
            </a>
        ...
        <li class="last">
            <!-- made image clickable link on May 12, 2016 -->
            <a href="<?php echo "viewPageTest.php?article=".$All8Article; ?>">
                <img src="<?php echo $All8Pic; ?>" alt="" style="height:100px;width:100px;" />
            </a>
